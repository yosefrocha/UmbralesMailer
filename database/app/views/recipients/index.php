            ...
            <div class="card-body">
                <form class="row g-3" method="get" action="/recipients">
                    ...
                    <div class="col-12 d-flex flex-wrap gap-2">
                        ...
                        <?php if (Auth::isAdmin()): ?>
                            <a href="/recipients/template" class="btn btn-outline-primary">Descargar plantilla CSV</a>
                        <?php endif; ?>
                    </div>
                </form>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <p class="small text-muted">
                        Columnas requeridas: email, first_name, last_name, institution, country, segment, status, consent_at
                    </p>
